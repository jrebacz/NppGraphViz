...
void GraphVizPreview::draw()
{
	...
	// Resize
    SetWindowPos(m_hDlg, NULL, 0, 0, bitmap.bmWidth + 40, bitmap.bmHeight + 60, SWP_NOMOVE | SWP_NOACTIVATE);
    SetWindowPos(pImage, NULL, 0, 0, bitmap.bmWidth + 40, bitmap.bmHeight + 60, SWP_NOMOVE | SWP_NOACTIVATE);
